    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('settings.save') }}" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Subtitulo do site</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                        <input type="color" name="bgcolor" value="{{ $settings['bgcolor'] }}" class="form-control form-control-color">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Cor de texto</label>
                    <div class="col-sm-1">
